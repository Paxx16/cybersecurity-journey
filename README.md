...
| Day | Topic | Vulnerabilities | Status |
|-----|-------|-----------------|--------|
| 1 | SQL Injection | Authentication Bypass, Data Extraction, Hash Cracking | Completed |
| 2 | Cross-Site Scripting | Reflected XSS, Stored XSS, Session Hijacking | Completed |
...
- Labs: DVWA, PortSwigger Web Security Academy
...
- Evaluacion y Explotacion de Vulnerabilidades
- Redaccion de Reportes de Seguridad
- Vulnerabilidades OWASP Top 10

### Resumen de Progreso

| Dia | Tema | Vulnerabilidades | Estado |
|-----|------|------------------|--------|
| 1 | Inyeccion SQL | Bypass de Autenticacion, Extraccion de Datos, Crackeo de Hashes | Completado |
| 2 | Cross-Site Scripting | XSS Reflejado, XSS Almacenado, Secuestro de Sesion | Completado |
...
- Proxy: Burp Suite Community Edition
- Laboratorios: DVWA, PortSwigger Web Security Academy
- Lenguajes: Python, Bash, PHP
